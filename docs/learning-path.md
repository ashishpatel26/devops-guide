...
* **[Git](tools/git.md)**: Learn to track changes, branch, and merge.
* **GitHub/GitLab**: Collaborate with others.
* **Goal**: Contribute to a repository.

## Phase 3: Containerization

* **[Docker](tools/docker.md)**: Learn to package applications.
...
* **[Jenkins](tools/jenkins.md)** or **GitHub Actions**.
* Automate testing and deployment.
* **Goal**: Build a pipeline that deploys your app automatically.

## Phase 5: Cloud Providers

* **[AWS](tools/aws.md)**, **Azure**, or **Google Cloud**.
* Learn EC2, S3, IAM, VPC.
* **Goal**: Deploy your app to the cloud manually.

## Phase 6: Infrastructure as Code (IaC)

* **[Terraform](tools/terraform.md)**: Provision infrastructure using code.
* **[Ansible](tools/ansible.md)**: Configuration management.
* **Goal**: Automate the creation of your cloud resources.

## Phase 7: Container Orchestration

* **[Kubernetes](tools/kubernetes.md)**: Manage containerized applications at scale.
* **[Helm](tools/helm.md)**: Kubernetes Package Manager to Easy Manage.
